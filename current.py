...
def render_current_stage():
    ...
    for cat in categories:
        ...
        for _, row in cat_data.iterrows():
            with st.expander(f"**Aspect:** {row['Aspect']}"):
                ...
                with col1:
                    # Placeholder image for each aspect; replace with actual images if available
                    st.image(
    ...
    st.write("---")
    st.info("End of Current Stage overview. Use the sidebar to explore other sections.")
