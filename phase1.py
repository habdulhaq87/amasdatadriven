...
def render_phase1():
    ...
    post_animation = load_lottie_animation("input/post.json")  # Animation for Post-Sale & Procurement
    ...
    for i, cat in enumerate(categories):
        ...
        with col_img:
            ...
            if cat == "Receiving & QC":
                ...
                st_lottie(post_animation, key="post_sale_proc", height=200, width=180)
            else:
